...
export const TERMINAL_KEY = process.env.NEXT_PUBLIC_TERMINAL_KEY as string;
export const TERMINAL_COMPANY_EMAIL = process.env.NEXT_PUBLIC_TERMINAL_COMPANY_KEY as string;
